...
class WeatherRepository7Timer(restTemplateBuilder: RestTemplateBuilder, val objectMapper: ObjectMapper) :
    ...
    private fun getResponse(city: City, product: String) =
            restTemplate.getForObject<String>("https://www.7timer.info/bin/$product.php?lon=${city.position.longitude}&lat=${city.position.latitude}&ac=0&unit=metric&output=json&tzshift=0")
}
